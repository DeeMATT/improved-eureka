...
var generateSSLForSubdomain = exports.generateSSLForSubdomain = async function generateSSLForSubdomain(fullyQualifiedSubdomain) {
  try {
    ...
    var feedback = await sshClient.putFile("./setupReverseProxyWithSSL.sh", "/opt/setupReverseProxyWithSSL.sh");

    var commandResponse = await sshClient.execCommand("sh /opt/setupReverseProxyWithSSL.sh " + fullyQualifiedSubdomain + " " + sampleProxy);
